var animations = (function (exports) {
  'use strict';
...
`).map((line) => line.trim()).filter(Boolean).map((line) => {
  ...
  exports.ImagesCompleteListener = ImagesCompleteListener;
  exports.applyAccentTypography = applyAccentTypography;
  exports.bounce = bounce;
  exports.calculateCirc = calculateCirc;
  exports.calculateIteration = calculateIteration;
  exports.calculateIterationProgress = calculateIterationProgress;
  exports.calculateTangentY1 = calculateTangentY1;
  exports.convertDegreesToRadians = convertDegreesToRadians;
  exports.convertRadiansToDegrees = convertRadiansToDegrees;
  exports.convertTangentToDegrees = convertTangentToDegrees;
  exports.convertToEaseInOut = convertToEaseInOut;
  exports.convertToEaseOut = convertToEaseOut;
  exports.convertToEaseOutIn = convertToEaseOutIn;
  exports.createBack = createBack;
  exports.createCalculator = createCalculator;
  exports.createCompositeCalculator = createCompositeCalculator;
  exports.createElastic = createElastic;
  exports.createPower = createPower;
  exports.createSinusCalculator = createSinusCalculator;
  exports.ease = ease;
  ...
  exports.easeOutIn = easeOutIn;
  exports.easeOutQuad = easeOutQuad;
  exports.easeSine = easeSine;
  exports.getLetterHTML = getLetterHTML;
